...
Friend Module database
    ...
    Public Sub dbOpen()
        ...
        conStr = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\RDO-13\Documents\GitHub\POS-Inventory\POSInventory - Copy\New Updte\POSInventory\SI_DB.accdb;Persist Security Info=False;"
    ...
    Friend Function SaveEntry(ByVal dsEntry As DataSet, Optional ByVal isNew As Boolean = True) As Boolean
        ...
        For Each dsTable As DataTable In dsEntry.Tables
            ...
            Dim cb As New OleDbCommandBuilder(da) 'Required in Saving/Update to Database
    ...
    Friend Sub SQLCommand(ByVal sql As String)
        conStr = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\DBInventory.accdb;Persist Security Info=False;"
        con = New OleDbConnection(conStr)
